...
class FoodFrame extends JFrame implements ActionListener
{
    ...
    FoodFrame()
    {
        ...
        ImageIcon FAVICON = new ImageIcon("\"D:\\Swing\\favicon_io\\icondis.png\"");
        ...
        ImageIcon I0 = new ImageIcon("D:\\Swing\\Food Icons/burgir.png");
        JB[0].setIcon(I0);
        JB[0].setText("BURGER - 100 RS");

        ImageIcon I1 = new ImageIcon("D:\\Swing\\Food Icons/cake.png");
        JB[1].setIcon(I1);
        JB[1].setText("CAKE - 70 RS");

        ImageIcon I2 = new ImageIcon("D:\\Swing\\Food Icons/nodl.png");
        JB[2].setIcon(I2);
        JB[2].setText("NOODLES - 60 RS");
    
        ImageIcon I3 = new ImageIcon("D:\\Swing\\Food Icons/boh woh.png");
        JB[3].setIcon(I3);
        JB[3].setText("WATER - 20 RS");

        ImageIcon I5 = new ImageIcon("D:\\Swing\\Food Icons/chicken.png");
        JB[5].setIcon(I5);
        JB[5].setText("CHICKEN - 120 RS");
    
        ImageIcon I6 = new ImageIcon("D:\\Swing\\Food Icons/fries.png");
        JB[6].setIcon(I6);
        JB[6].setText("FRIES - 70 RS");
    
        ImageIcon I7 = new ImageIcon("D:\\Swing\\Food Icons/nacho.png");
        JB[7].setIcon(I7);
        JB[7].setText("NACHOES - 50 RS");
    
        ImageIcon I8 = new ImageIcon("D:\\Swing\\Food Icons/lemonade.png");
        JB[8].setIcon(I8);
        JB[8].setText("LEMONADE - 15 RS");
    
        ImageIcon I10 = new ImageIcon("D:\\Swing\\Food Icons/pizzaz.png");
        JB[10].setIcon(I10);
        JB[10].setText("PIZZA - 120 RS");

        ImageIcon I11 = new ImageIcon("D:\\Swing\\Food Icons/samosa.png");
        JB[11].setIcon(I11);
        JB[11].setText("SAMOSA - 30 RS");
    
        ImageIcon I12 = new ImageIcon("D:\\Swing\\Food Icons/taco.png");
        JB[12].setIcon(I12);
        JB[12].setText("TACO - 50 RS");
    
        ImageIcon I13 = new ImageIcon("D:\\Swing\\Food Icons/soda.png");
        JB[13].setIcon(I13);
        ...
        ImageIcon I9 = new ImageIcon("D:\\Swing\\Food Icons/parcel.png");
        JB[9].setIcon(I9);
        JB[9].setText("PARCEL? :/");
        JB[9].setForeground(Color.black);
        JB[9].setBackground(Color.cyan);

        ImageIcon I4 = new ImageIcon("D:\\Swing\\Food Icons/fnla.png");
        JB[4].setIcon(I4);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if (e.getSource()==JB[14])
        {
            ...
            ImageIcon but_why_tho = new ImageIcon("D:\\Swing\\Food Icons/derp.png");
